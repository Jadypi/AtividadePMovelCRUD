    ...
    async function fazerLogin() {
        if (email == '') {
            ...
            if (resultado == 'sucesso') {
                navigation.navigate('ListarProdutos') //replace apaga as telas anteriores da pilha. Caso o usuário clique no voltar do celular não volta para a tela de login
            } else
